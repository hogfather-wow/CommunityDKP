if GetLocale() == "deDE" then
  ...
  core.L = {
    ...
    DEFAULTMINMAXDKPVALUES = "DKP Grenzwerte",
    ...
    MAXIMUMDKP = "DKP-Deckelung",
    MAXIMUMDKPTTDESC = "Die DKP-Deckelung bestimmt die DKP Obergrenze. Haben Spieler diese Obergrenze erreicht, werden ihnen keine DKP mehr gutgeschrieben. Auf 0 setzen, wenn keine DKP-Deckelung gewünscht ist.",
    ...
    MINIMUMDKP = "Mindest-DKP",
    MINIMUMDKPTTDESC = "Setzt die DKP auf die Minimum DKP für die Spieler in der DKP-Tabelle, deren DKP niedriger als die Minimum DKP ist.",
    MINIMUMDKPTTWARN = "Diese Änderung wird an alle Online-Spieler in deiner Gilde gesendet.",
